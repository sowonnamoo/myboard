...
window.viewDetail = async function(id) {
    ...
    // 전화번호를 훼손하지 않고 그대로 사용합니다!
    const finalCode = (data.phone || "00000000000") + timeCode; 
    ...
    dImage.innerHTML = `
        <div id="image-container" style="position: relative; width: 744px; height: 500px; margin: 0 auto; border: 1px solid black; display: flex; align-items: center; justify-content: center; background-color: #f9f9f9;">
            <p id="loading-msg" style="color: #666; font-size: 16px; text-align: center;">시안이 제작중 입니다.<br>결제확인 되시면 제작후 업로드 됩니다.</p>
            <a id="image-link" href="#" target="_blank" style="display: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
                <img src="${imgUrl}?t=${timestamp}" 
                     ...
                     onload="
                        ...
                        document.getElementById('image-link').href = '${imgUrl}?t=${timestamp}';
                     "
