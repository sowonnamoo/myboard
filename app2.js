    ...
    confirmBtn.onclick = async () => {
        ...
        if (inputVal === passToCompare) {
            ...
            if (dImage) {
               ...
               dImage.innerHTML = `
                tyle="position: relative; width: 744px; height: 500px; margin: 0; border: none; display: flex; align-items: center; justify-content: flex-start; background-color: #f9f9f9;">
        ...
        <a href="water.html?url=${encodeURIComponent(imgUrl + '?t=' + timestamp)}" target="_blank" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
