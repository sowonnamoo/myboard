...
if (dImage) {
    ...
    const phone = data.phone || "00000000000";
    const finalCode = phone + timeCode;
    
    const imgUrl = `https://sowonnamoo1005.cafe24.com/1/${finalCode}.jpg`;
    const timestamp = new Date().getTime();

    dImage.innerHTML = `
        <div id="image-container" style="position: relative; width: 744px; height: 500px; margin: 0 auto; border: 1px solid black; display: flex; align-items: center; justify-content: center; background-color: #f9f9f9; overflow: hidden;">
            <p id="loading-msg" style="color: #666; font-size: 16px; text-align: center; position: absolute;">
                시안이 제작중 입니다.<br>결제확인 되시면 제작후 업로드 됩니다.
            </p>
            <img id="main-image" src="${imgUrl}?t=${timestamp}" 
                 ...
                 onload="
                    ...
                    this.onclick = function() { window.open('${imgUrl}?t=${timestamp}', '_blank'); };
                 ">
        </div>
