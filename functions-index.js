        ...
        for (const docSnap of snap.docs) {
            ...
            try {
                ...
                await boardRef.set({
                    ...
                    size: "",
                    price: "",
                    file1Url: data.file1Url || null,
                    file2Url: data.file2Url || null,
                ...
                // m/k/s 파일 분류 - 관리자 전용 저장소에만 기록 (게시글에는 노출 안 됨)
                await db.collection("adminOrders").doc(boardId).set({
                    phone: data.password,
                    address: "",
                    message: data.message,
                    uid: data.createdByAdminUid || null,
                    file1Type: data.file1Type || null,
                    file2Type: data.file2Type || null
                });
